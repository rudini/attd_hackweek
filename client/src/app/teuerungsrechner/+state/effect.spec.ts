        ...
        \"context\": [
          {
            \"key\": \"\",
            \"type\": {
              \"name\": \"{ timeDimension: Array<{ id: number, month: number, year: number, name: string }>, indexDimension: Array<{ id: number, month: number, year: number, name: string }>, facts: Array<{ timeDim: number, indexDim: number, indexValue: number }> }\",
              \"props\": {
                \"timeDimension\": {
                  \"name\": \"Array<{ id: number, month: number, year: number, name: string }>\",
                  \"type\": {
                ...
                \"facts\": {
                  \"name\": \"Array<{ timeDim: number, indexDim: number, indexValue: number }>\",
                  \"type\": {
